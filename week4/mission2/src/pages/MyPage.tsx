          ...
          <div className="bg-white w-[520px] rounded-3xl shadow-lg p-10 flex flex-col items-center">
            ...
            <div className="w-full flex flex-col mb-4">
              ...
              <input
                ...
                className="border p-3 rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-purple-300"
              />
            </div>
            ...
            <div className="flex gap-4 mt-2">
              <button
                onClick={handleSave}
                className="bg-purple-200 text-black px-6 py-2 rounded-lg hover:bg-purple-300 transition"
              >
                저장
              </button>
              <button
