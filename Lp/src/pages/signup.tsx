    ...
    return (
        <div className="flex h-[100dvh] items-center justify-center bg-black text-white">
            <div className="w-90 flex flex-col items-center p-3 gap-8"> 
                <Header title="회원가입"/>
                <form className="flex flex-col items-center p-3 gap-8 w-full"
                ...
                {step==1 && (
                    <>
                        ...
                        <div className="flex flex-col w-full">
                            ...
                            {!!errors.email && !!touchedFields?.email && (<div className="text-red-500">{errors.email?.message}</div>)}
                        </div>
                        <button 
                ...
                {step==2 && (
                    <div className="flex flex-col w-full gap-3">
                        ...
                        <div className="relative">
                            ...
                            {!!errors.password && !!touchedFields?.password && (<div className="text-red-500">{errors.password?.message}</div>)}
                        </div>
                        <div className="relative">
                            <input
                            ...
                            {!!errors.passwordCheck && !!touchedFields?.passwordCheck && (<div className="text-red-500">{errors.passwordCheck?.message}</div>)}
                        </div>
                        <button 
                            className="w-full h-12 rounded-md bg-pink-500 cursor-pointer disabled:bg-[#252525ff] disabled:cursor-default"
                            onClick={() => setStep(3)} 
                ...
                {step==3 && (
                    <div className="w-full flex flex-col items-center gap-5">
                        ...
                        <input
                            ...
                            />
                        {!!errors.name && !!touchedFields?.name && (<div className="text-red-500">{errors.name?.message}</div>)}
